...
[![Current release](https://img.shields.io/badge/release-v2.0.5-14b8a6)](https://github.com/NyxCloudRO/Veleis/releases/tag/v2.0.5)
...
Current stable release: **Veleis 2.0.5** · Schema 54 · linux/amd64
...
`nyxmael/veleis:2.0.5` image, detects effective cgroup memory, provisions a
...
Veleis 2.0.5 is currently validated on the following amd64 platforms:
...
- Adaptive Anomaly Detection for CPU, memory, and network signals using robust
  statistics, with explainable evidence, confidence, bounded learning states,
  and guarded adoption of stable new regimes.
...
`sudo veleis upgrade 2.0.5`. Existing 2.0.0 through 2.0.4 installations
