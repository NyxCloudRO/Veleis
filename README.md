...
[![Current release](https://img.shields.io/badge/release-v1.8.1-14b8a6)](https://github.com/NyxCloudRO/Veleis/releases/tag/v1.8.1)
...
Current stable release: **Veleis 1.8.1** · Schema 33 · linux/amd64
...
`nyxmael/veleis:1.8.1` image, provisions TimescaleDB, applies schema migrations,
...
Existing 1.7.1 and 1.8.0 installations can upgrade with `sudo veleis upgrade`; the exact
version alternative is `sudo veleis upgrade 1.8.1`. Installations created before
...
Use [GitHub Issues](https://github.com/NyxCloudRO/Veleis/issues) for bugs,
documentation problems, and focused feature requests. Read [SUPPORT.md](SUPPORT.md)
before posting logs. Report vulnerabilities privately according to
