...
[![Current release](https://img.shields.io/badge/release-v1.8.6-14b8a6)](https://github.com/NyxCloudRO/Veleis/releases/tag/v1.8.6)
...
Current stable release: **Veleis 1.8.6** · Schema 36 · linux/amd64
...
`nyxmael/veleis:1.8.6` image, provisions TimescaleDB, applies schema migrations,
...
Veleis 1.8.6 is currently validated on the following amd64 platforms:
...
Existing 1.7.1, 1.8.0, 1.8.1, 1.8.2, 1.8.3, 1.8.4, and 1.8.5 installations can upgrade with
`sudo veleis upgrade`; the exact version alternative is
`sudo veleis upgrade 1.8.6`. Installations created before the lifecycle command
