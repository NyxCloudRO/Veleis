...
Not in 1.7.1. The accepted public image is linux/amd64 only.
...
Use `sudo veleis upgrade`. Veleis 1.7.0 upgrades to the current 1.7.1 stable
release after a mandatory backup and immutable-digest verification. On 1.7.1,
...
The supported 1.7.1 installer uses its generated certificate.
