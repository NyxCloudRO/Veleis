...
Not in 1.8.2. The accepted public image is linux/amd64 only.
...
1.8.2 stable release after a mandatory backup and immutable-digest verification. On 1.8.2,
...
The supported 1.8.2 installer uses its generated certificate.
