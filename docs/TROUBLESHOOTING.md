...
Error contains `unsupported operating system`. Veleis 2.0.3 is accepted only on
...
```bash
sudo docker pull nyxmael/veleis:2.0.3
...
readiness, sufficient free space, schema 53 in a clean migration state, and no
