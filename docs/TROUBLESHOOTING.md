...
Error contains `unsupported operating system`. Veleis 1.8.6 is accepted only on
...
```bash
sudo docker pull nyxmael/veleis:1.8.6
...
readiness, sufficient free space, schema 36 in a clean migration state, and no
