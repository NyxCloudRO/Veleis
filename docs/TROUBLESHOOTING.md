...
Error contains `unsupported operating system`. Veleis 2.0.2 is accepted only on
...
```bash
sudo docker pull nyxmael/veleis:2.0.2
...
readiness, sufficient free space, schema 51 in a clean migration state, and no
