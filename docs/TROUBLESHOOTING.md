...
Error contains `unsupported operating system`. Veleis 2.0.6 is accepted only on
...
```bash
sudo docker pull nyxmael/veleis:2.0.6
...
readiness, sufficient free space, schema 54 in a clean migration state, and no
