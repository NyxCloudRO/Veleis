...
```bash
docker pull nyxmael/veleis:1.8.0
```
...
| `1.8.0` | Immutable exact current release. It will not move to another build. | `sha256:b1a3b106599d8b297f48a4573051c3dc646e12bd69c35cfbdae4d49edafff85b` |
| `1.8` | Floating minor track: newest accepted stable `1.8.x`. | Same as `1.8.0` |
| `latest` | Floating newest accepted stable release. | Same as `1.8.0` |

The `1.7` tag remains on the newest accepted 1.7 patch. `1.8` tracks accepted
1.8 releases, and `latest` resolves to the accepted 1.8.0 image.
