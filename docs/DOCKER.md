...
```bash
docker pull nyxmael/veleis:1.8.2
```
...
| `1.8.2` | Immutable exact current release. It will not move to another build. | `sha256:074c9a6584873e07a793fdb0eaff24f32e292aa387a57314109380f6d1efbda4` |
| `1.8` | Floating minor track: newest accepted stable `1.8.x`. | Same as `1.8.2` |
| `latest` | Floating newest accepted stable release. | Same as `1.8.2` |

The `1.7` tag remains on the newest accepted 1.7 patch. `1.8` tracks accepted
1.8 releases, and `latest` resolves to the accepted 1.8.2 image.
