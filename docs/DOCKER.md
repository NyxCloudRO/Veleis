...
```bash
docker pull nyxmael/veleis:1.8.1
```
...
| `1.8.1` | Immutable exact current release. It will not move to another build. | `sha256:5afeb90ec365282990a080c0cc26e84d2fffe69986a87c48612abb9a3260fcfe` |
| `1.8` | Floating minor track: newest accepted stable `1.8.x`. | Same as `1.8.1` |
| `latest` | Floating newest accepted stable release. | Same as `1.8.1` |

The `1.7` tag remains on the newest accepted 1.7 patch. `1.8` tracks accepted
1.8 releases, and `latest` resolves to the accepted 1.8.1 image.
