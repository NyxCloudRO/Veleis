...
Veleis **2.0.7** is the current stable release.

| Component                  | Release identity                 |
| -------------------------- | -------------------------------- |
| Application                | `2.0.7`                          |
| Git tag and GitHub Release | `v2.0.7`                         |
| Installer target           | `docker.io/nyxmael/veleis:2.0.7` |
...
2.0.6 to 2.0.7 use a mandatory pre-upgrade backup. Schema 54 is current;
upgrades apply every required migration through schema 54. Sources on 2.0.0
through 2.0.5 refresh the lifecycle tool before upgrading.

## Supported versions

| Version | Status                                          |
| ------- | ----------------------------------------------- |
| 2.0.7   | Current public stable release                   |
| 2.0.6   | Supported direct upgrade source for 2.0.7       |
| 2.0.5   | Lifecycle-gated upgrade source for 2.0.7        |
| 2.0.4   | Lifecycle-gated upgrade source for 2.0.7        |
| 2.0.3   | Lifecycle-gated upgrade source for 2.0.7        |
| 2.0.2   | Lifecycle-gated upgrade source for 2.0.7        |
| 2.0.1   | Lifecycle-gated upgrade source for 2.0.7        |
| 2.0.0   | Lifecycle-gated upgrade source for 2.0.7        |
| 1.8.x   | Supported upgrade source line for 2.0.7         |
| 1.7.1   | Supported upgrade source for 2.0.7              |
...
- Exact version tags such as `2.0.0` through `2.0.7` are immutable.
...
- Git tags use `v` (`v2.0.7`); application and Docker versions do not.
