...
Veleis **1.8.5** is the current stable release.

| Component | Release identity |
| --------- | ---------------- |
| Application | `1.8.5` |
| Git tag and GitHub Release | `v1.8.5` |
| Installer target | `docker.io/nyxmael/veleis:1.8.5` |
| Docker manifest | `sha256:cab41f4a7f63a2ac39295cac1940ff8c524ddf220f6083d2934d977210feb621` |
| Schema | 35 |
| Backup format | 1 |

All prior releases remain immutable at their original Docker digests and
GitHub releases. Upgrades from 1.7.1, 1.8.0, 1.8.1, 1.8.2, 1.8.3, or 1.8.4 to
1.8.5 use a mandatory pre-upgrade backup; schema 32, 33, or 34 advances to 35.
...
| 1.8.4 | Supported upgrade source for 1.8.5 |
| 1.8.3 | Supported upgrade source for 1.8.5 |
| 1.8.2 | Supported upgrade source for 1.8.5 |
| 1.8.1 | Supported upgrade source for 1.8.5 |
| 1.8.0 | Supported upgrade source for 1.8.5 |
| 1.7.1 | Supported upgrade source for 1.8.5 |
...
- Exact version tags such as `1.8.4` and `1.8.5` are immutable.
...
- Git tags use `v` (`v1.8.5`); application and Docker versions do not.
