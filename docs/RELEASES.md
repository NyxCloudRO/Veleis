...
Veleis **1.8.12** is the current stable release.

| Component                  | Release identity                             |
| -------------------------- | -------------------------------------------- |
| Application                | `1.8.12`                                     |
| Git tag and GitHub Release | `v1.8.12`                                    |
| Installer target           | `docker.io/nyxmael/veleis:1.8.12`            |
| Docker manifest            | `sha256:9ccee823388e437012143eaf622bf8e7d91ffaf6edb0d06cc861cff10fa27e90` |
| Schema                     | 45                                           |
| Backup format              | 1                                            |
...
1.8.5, 1.8.6, 1.8.7, 1.8.8, 1.8.9, 1.8.10, or 1.8.11 to 1.8.12 use a mandatory
pre-upgrade backup. Schema 45 is current; upgrades apply every required
migration through schema 45.
...
| 1.8.11  | Supported upgrade source for 1.8.12                                     |
| 1.8.10  | Supported upgrade source for 1.8.12                                     |
| 1.8.9   | Supported upgrade source for 1.8.12                                     |
| 1.8.8   | Supported upgrade source for 1.8.12                                     |
| 1.8.7   | Supported upgrade source for 1.8.12                                     |
| 1.8.6   | Supported upgrade source for 1.8.12                                     |
| 1.8.5   | Supported upgrade source for 1.8.12                                     |
| 1.8.4   | Supported upgrade source for 1.8.12                                     |
| 1.8.3   | Supported upgrade source for 1.8.12                                     |
| 1.8.2   | Supported upgrade source for 1.8.12                                     |
| 1.8.1   | Supported upgrade source for 1.8.12                                     |
| 1.8.0   | Supported upgrade source for 1.8.12                                     |
| 1.7.1   | Supported upgrade source for 1.8.12                                     |
...
- Exact version tags such as `1.8.11` and `1.8.12` are immutable.
...
- Git tags use `v` (`v1.8.12`); application and Docker versions do not.
