...
readonly VELEIS_VERSION="2.0.5"
readonly VELEIS_IMAGE="docker.io/nyxmael/veleis:${VELEIS_VERSION}"
readonly LIFECYCLE_URL="https://github.com/NyxCloudRO/Veleis/releases/download/v2.0.5/veleis"
readonly LIFECYCLE_SHA256="9a8dfc4d561963a4f8a21d065a14b1d5988a650597dc8679a8f0e093783876cd"
readonly RELEASE_METADATA_URL="https://github.com/NyxCloudRO/Veleis/releases/download/v2.0.5/release.json"
readonly RELEASE_METADATA_SHA256="79b6c8b4df6604fdbb88aeab397f118101136ee8806b0d215288bbf9d066c7e0"
readonly POSTGRES_MEMORY_URL="https://github.com/NyxCloudRO/Veleis/releases/download/v2.0.5/veleis-postgres-memory.sh"
...
services:
  ...
  veleis:
    ...
    environment:
      ...
      VELEIS_SESSION_INACTIVITY_TIMEOUT: ${VELEIS_SESSION_INACTIVITY_TIMEOUT:-30m}
      VELEIS_SESSION_ABSOLUTE_LIFETIME: ${VELEIS_SESSION_ABSOLUTE_LIFETIME:-168h}
...
case "${ID:-}:${VERSION_ID:-}" in
  ...
  *) fail "unsupported operating system '${ID:-unknown} ${VERSION_ID:-unknown}'; Veleis ${VELEIS_VERSION} supports $SUPPORTED_PLATFORMS" ;;
esac
...
case "$architecture" in
  ...
  *) fail "unsupported architecture '$architecture'; Veleis ${VELEIS_VERSION} supports linux/amd64" ;;
esac
...
jq -e '.product == "Veleis" and .version == "2.0.5" and .schema == 54 and .backup_format_version == 1' "$TEMPORARY_DIRECTORY/release.json" >/dev/null || fail "release metadata is incompatible"
