...
readonly VELEIS_VERSION="1.8.12"
readonly VELEIS_IMAGE="docker.io/nyxmael/veleis:${VELEIS_VERSION}"
readonly LIFECYCLE_URL="https://github.com/NyxCloudRO/Veleis/releases/download/v1.8.12/veleis"
readonly LIFECYCLE_SHA256="a107e1acd6f9e8940cf38646fbae52a78554234c6886310c4cee836fcb2bcf43"
readonly RELEASE_METADATA_URL="https://github.com/NyxCloudRO/Veleis/releases/download/v1.8.12/release.json"
readonly RELEASE_METADATA_SHA256="7723957a56e91a0aedacc1032fdda249a245dc99f22a5ec769adcbdd1541f6dc"
...
case "${ID:-}:${VERSION_ID:-}" in
  ...
  *) fail "unsupported operating system '${ID:-unknown} ${VERSION_ID:-unknown}'; Veleis 1.8.12 supports $SUPPORTED_PLATFORMS" ;;
esac
...
case "$architecture" in
  ...
  *) fail "unsupported architecture '$architecture'; Veleis 1.8.12 supports linux/amd64" ;;
esac
