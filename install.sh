...
readonly RELEASE_METADATA_SHA256="f16336c2e331999fbfcfcf2ffdd35d0802d28c663b01c6cb19fe66dc0a74d845"
...
case "${ID:-}" in
  debian | ubuntu) ;;
  *) fail "unsupported operating system '${ID:-unknown}'; Veleis 1.8.1 supports tested Debian and Ubuntu releases" ;;
esac
...
case "$architecture" in
  ...
  *) fail "unsupported architecture '$architecture'; Veleis 1.8.1 supports linux/amd64" ;;
esac
...
jq -e '.product == "Veleis" and .version == "1.8.1" and .schema == 33 and .backup_format_version == 1' "$TEMPORARY_DIRECTORY/release.json" >/dev/null || fail "release metadata is incompatible"
