...
readonly VELEIS_VERSION="2.0.4"
readonly VELEIS_IMAGE="docker.io/nyxmael/veleis:${VELEIS_VERSION}"
readonly LIFECYCLE_URL="https://github.com/NyxCloudRO/Veleis/releases/download/v2.0.4/veleis"
readonly LIFECYCLE_SHA256="9a8dfc4d561963a4f8a21d065a14b1d5988a650597dc8679a8f0e093783876cd"
readonly RELEASE_METADATA_URL="https://github.com/NyxCloudRO/Veleis/releases/download/v2.0.4/release.json"
readonly RELEASE_METADATA_SHA256="7bc7f3fea05ced4a206e3b57dc9986f2cfcf0a71d6324a33fca87546e6d690b1"
readonly POSTGRES_MEMORY_URL="https://github.com/NyxCloudRO/Veleis/releases/download/v2.0.4/veleis-postgres-memory.sh"
...
jq -e '.product == "Veleis" and .version == "2.0.4" and .schema == 54 and .backup_format_version == 1' "$TEMPORARY_DIRECTORY/release.json" >/dev/null || fail "release metadata is incompatible"
